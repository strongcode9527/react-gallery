...
/******/ 	var hotCurrentHash = "3cfa95da38a7b5060420"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	//获取图片信息，返回一个数组，数组的元素是图片信息的对象。
	var React = __webpack_require__(6);
	var ReactDom = __webpack_require__(43);
	var imagedata = __webpack_require__(173);
	var Gallery = __webpack_require__(174);
	var Dom = document.getElementById('container');
	console.log(Dom);
	document.write('wod  asfeef');
	ReactDom.render(React.createElement(Gallery, null), Dom);
